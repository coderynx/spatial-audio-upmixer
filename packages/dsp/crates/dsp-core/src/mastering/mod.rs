//! Mastering-bus stages. Ordering is contracted — reference match, EQ,
//! compression, bass control, BS.1770 loudness, then the look-ahead limiter
//! last — and lives with the caller in `mastering/chain.py`.
