...
_BLOCK_REGISTRY: dict[str, BlockMapping] = {
    "engine": {
        ...
        "stem_phase_fix":               ("config", "stem_phase_fix"),
        "stem_phase_fix_low_hz":        ("config", "stem_phase_fix_low_hz"),
        "stem_phase_fix_high_hz":       ("config", "stem_phase_fix_high_hz"),
        "stem_phase_fix_scale":         ("config", "stem_phase_fix_scale"),
        "stem_phase_fix_reference_model": ("config", "stem_phase_fix_reference_model"),
...
_FIELD_MAP: dict[str, tuple[str, type]] = {
    ...
    "stem_transient_duck":        ("stem_transient_duck",      float),
    ...
    "stem_phase_fix":              ("stem_phase_fix",              dict),
    "stem_phase_fix_low_hz":       ("stem_phase_fix_low_hz",       float),
    "stem_phase_fix_high_hz":      ("stem_phase_fix_high_hz",      float),
    "stem_phase_fix_scale":        ("stem_phase_fix_scale",        float),
    "stem_phase_fix_reference_model": ("stem_phase_fix_reference_model", str),
