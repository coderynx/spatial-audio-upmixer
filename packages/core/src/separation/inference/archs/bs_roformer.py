"""BS-RoFormer band-split source-separation architecture.

Ported from lucidrains' bs-roformer (MIT license) as vendored in
python-audio-separator's uvr_lib_v5/roformer/bs_roformer.py. Model
