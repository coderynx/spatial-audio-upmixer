"""Scaled dot-product attention shared by the Roformer architectures.

Ported from lucidrains' BS-RoFormer / Mel-Band-RoFormer implementations as
vendored (MIT license) in python-audio-separator's uvr_lib_v5/roformer.
"""
