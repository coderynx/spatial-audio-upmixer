...
STEM_EQ_PRESETS_BY_STEM: dict[str, tuple[str, ...]] = {
    ...
    "Vocals Reverb": ("vocals-reverb-cleanup",),
...
STEM_EQ_SETTINGS: dict[str, dict[str, Any]] = {
    ...
    "vocals-reverb-cleanup": _preset(preset="vocals-reverb-cleanup", highpass={"enabled": True, "freq_hz": 180.0}, bell_1={"enabled": True, "freq_hz": 350.0, "gain_db": -1.5, "q": 1.0}),
