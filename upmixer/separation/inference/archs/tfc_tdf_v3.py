"""TFC-TDF v3 (MDX23C) time-frequency source-separation architecture.

Ported from ZFTurbo's Music-Source-Separation-Training (MIT license) as
vendored in python-audio-separator's uvr_lib_v5/tfc_tdf_v3.py. Model
hyperparameters are supplied by the checkpoint's YAML config; see
upmixer/separation/inference/config.py and inference/configs/.
"""
import torch
