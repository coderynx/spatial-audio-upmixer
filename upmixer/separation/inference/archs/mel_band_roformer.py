"""Mel-Band RoFormer source-separation architecture.

Ported from lucidrains' mel-band-roformer (MIT license) as vendored in
python-audio-separator's uvr_lib_v5/roformer/mel_band_roformer.py. Model
