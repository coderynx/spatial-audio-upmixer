...
from upmixer_web.worker_peaks import PeaksMixin
from upmixer_web.worker_reference_match import ReferenceMatchMixin
...
class WorkerManager(ReferenceMatchMixin, PeaksMixin):
