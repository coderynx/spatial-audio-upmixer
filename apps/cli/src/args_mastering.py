...
def add_mastering_args(parser: argparse.ArgumentParser) -> None:
    ...
    parser.add_argument("--mastering-bass-harmonics", type=float, default=None, metavar="A",  help="Harmonic enhancement amount (0.0–1.0); 0 bypasses it.")
    parser.add_argument("--mastering-bass-excite", action="store_true", help=argparse.SUPPRESS)
