...
export const TEST_SERVED_CONSTANTS: ServedEngineConstants = {
  ...
  bass_profiles: {
    boost: { sub_gain_db: 2.0, mid_gain_db: 1.0, unify_hz: null, spread: "bed", punch: 0.0, excite: false, lfe_mode: "off", lfe_send: 0.0, lfe_gain_db: 1.5 },
    cut: { sub_gain_db: -2.5, mid_gain_db: -1.5, unify_hz: null, spread: "bed", punch: 0.0, excite: false, lfe_mode: "off", lfe_send: 0.0, lfe_gain_db: -1.0 },
    mono: { sub_gain_db: 0.0, mid_gain_db: 0.0, unify_hz: 90.0, spread: "front", punch: 0.0, excite: false, lfe_mode: "off", lfe_send: 0.0, lfe_gain_db: 0.0 },
    enhance: { sub_gain_db: 1.5, mid_gain_db: 0.5, unify_hz: 90.0, spread: "bed", punch: 0.2, excite: true, lfe_mode: "add", lfe_send: 0.25, lfe_gain_db: 1.0 },
    deep: { sub_gain_db: 1.0, mid_gain_db: 0.5, unify_hz: 90.0, spread: "bed", punch: 0.25, excite: true, lfe_mode: "add", lfe_send: 0.3, lfe_gain_db: 1.0 },
    cinema: { sub_gain_db: 1.0, mid_gain_db: 0.0, unify_hz: 80.0, spread: "bed", punch: 0.0, excite: false, lfe_mode: "split", lfe_send: 0.5, lfe_gain_db: 0.0 },
  },
