...
The same React build also runs in Tauri. Start the API first, then:
...
- `src-tauri/` — macOS host, native DSP session, audio decode/resampling, and the PHASE output bridge.
